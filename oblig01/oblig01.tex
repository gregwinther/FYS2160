...
Now I wish to approximate this function for large systems with $N>>1$. I have tried to do this with my pencil on a piece of paper, but I was quickly lost in the algebraic jungle. Instead I turn to Python symbolic computation package:
\begin{lstlisting}
