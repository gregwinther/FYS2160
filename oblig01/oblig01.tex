...
\lstinputlisting[firstline=5, lastline=29]{scripts/EinsteinCrystal.py}
...
\lstinputlisting[firstline=32, lastline=44]{scripts/EinsteinCrystal.py}
...
\lstinputlisting[firstline=5, lastline=48]{scripts/RandomSpin.py}
